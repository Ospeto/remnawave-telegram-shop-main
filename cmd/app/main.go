...
func main() {
	...
	b.RegisterHandler(bot.HandlerTypeMessageText, "/trial", bot.MatchTypeExact, h.TrialCommandHandler, h.SuspiciousUserFilterMiddleware, h.CreateCustomerIfNotExistMiddleware)
