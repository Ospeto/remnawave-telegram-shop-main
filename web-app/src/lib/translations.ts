...
export const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'referral_activity_unavailable': 'Referral activity is temporarily unavailable. Your totals are still shown above.',
        'referral_totals_unavailable': 'Referral totals are temporarily unavailable. Try again in a moment.',
    ...
    my: {
        ...
        'referral_activity_unavailable': 'ဖိတ်ခေါ်မှုမှတ်တမ်းကို ယာယီ မရရှိနိုင်သေးပါ။ အပေါ်ရှိ စုစုပေါင်းတန်ဖိုးများကိုတော့ ဆက်လက်ပြသထားပါသည်။',
        'referral_totals_unavailable': 'ဖိတ်ခေါ်မှု စုစုပေါင်းတန်ဖိုးများကို ယာယီ မရရှိနိုင်သေးပါ။ ခဏနေပြီး ထပ်ကြိုးစားပါ။',
